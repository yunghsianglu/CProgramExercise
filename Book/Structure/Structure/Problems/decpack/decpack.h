...
// Insert a decimal value into the DecPack object. The new value is at
...
// print the values stored in the object, the first inserted value
// should be printed the first
// make sure the printed values are between '0' and '9'
