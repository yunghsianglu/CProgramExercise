...
// make sure compiler does not add space between the attributes
#pragma pack(1)     

// A BMP file has a header (54 bytes) and data

// uint16_t is a new data type, it is equivalent to unsigned short int
// u: unsigned
// 16: 16 bits, a short integer
// t: a type
