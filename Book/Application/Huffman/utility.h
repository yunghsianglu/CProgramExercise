...
// whichbit indicates which bit this is written to (0 means left most,
// 7 means right most)
// curbyte is the current byte
//
// if whichbit is zero, curbyte is reset and bit is put to the
// leftmost bit
// 
// when which bit reaches 7, this byte is written to the file and
// whichbit is reset
// 
